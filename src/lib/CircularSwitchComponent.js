...
export class CircularSwitchComponent extends React.Component{
  constructor(props){
    super(props);
    this.state = {
      value: props.value,
    ...
    return(<Field {...this.props}>
        <View style={[formStyles.container, this.props.containerStyle]} onLayout={this.handleLayoutChange.bind(this)}>
          ...
          <TouchableOpacity onPress={this.toggleValue.bind(this)} style={formStyles.labelContainer}>
            <Text lineBreakMode="tail" numberOfLines={2} style={[formStyles.label, this.props.labelStyle]}>{this.props.label}</Text>
          </TouchableOpacity>
        </View>
...
CircularSwitchComponent.propTypes = {
